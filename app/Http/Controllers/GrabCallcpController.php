...
class GrabCallCpController extends Controller
{
	public function getDataGrabCall(Request $request){
		    $input = json_decode(file_get_contents('php://input'),true);
        $rs_create = $this->createconsultant($request, $input);
        if($rs_create){
    ...
    public function createconsultant(Request $request, $input){
        ...
        /*begin include variable*/
        $name = ''; $email = ''; $phone = ''; $address = ''; $time = ''; $sex = 0; $branch = ''; $url = ''; $note = '';
        $ip = ""; $type = ""; $facebookName = ""; $facebookUid = ""; $firstname = ""; $middle = "" ; $lastname ="";
        /*end*/ 
        ...
        $message = "success ".$_list_idcat.'-'.$_id_post_type.'-'.$_id_status_type.'- last_id: '.$_last_id.'- exist: '.$_slug;
        return true;
