...
existboxlink();*/
var tgl_baner_side = false;
window.addEventListener("scroll", quick_banner_side,false);
var _width_device = (window.innerWidth > 0) ? window.innerWidth : screen.width;
var _height_device = (window.innerHeight > 0) ? window.innerHeight : screen.height;
console.log(_height_device);
var _e_window = document.getElementsByClassName("copyright")[0];
_e_window.addEventListener("click",function(){
  alert('w:'+_width_device+' - h:'+_height_device);
});
var _e_c_layout_page = document.getElementsByClassName("c-layout-page")[0];
var _e_side_left = document.getElementsByClassName("side-left")[0];
var _e_side_right = document.getElementsByClassName("side-right")[0];
var _e_footer = document.getElementsByClassName("c-layout-footer")[0];
//var _e_footer = document.getElementsByTagName('footer')[0];
//var _pos_footer = _e_footer.getBoundingClientRect();
var _get_side_left = _e_side_left.getBoundingClientRect();
var _top_maxleft = _get_side_left.top;
function quick_banner_side(){
     var top = window.pageYOffset;
     var _get_c_layout_page = _e_c_layout_page.getBoundingClientRect();
     let _top_page = _get_c_layout_page.top;
     if(_top_page < 0 ){
        _e_side_left.style.top = 160 +'px';
        _e_side_right.style.top = 160 +'px';
     }else{
        _e_side_left.style.top = 330 +'px';
        _e_side_right.style.top = 330 +'px';
     }
     /*var pos_e_footer = _e_footer.getBoundingClientRect();
     console.log(pos_e_footer.top,_get_side_left.bottom);
     if((pos_e_footer.top + 100) < _get_side_left.bottom){
          _e_side_right.style.position = 'absolute';
          _e_side_left.style.position = 'absolute';
     }else{
          _e_side_right.style.position = 'fixed';
          _e_side_left.style.position = 'fixed';
     } */
}