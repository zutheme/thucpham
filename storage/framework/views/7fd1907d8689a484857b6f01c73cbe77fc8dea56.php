...
<?php $__env->startSection('other_styles'); ?>
	...
	<link href="<?php echo e(asset('gentelella/build/css/epos.css?v=0.4.1')); ?>" rel="stylesheet">
      ...
      <div class="info">
        ...
        <table>
			<tr class="service">
				<td>
					<tr>
						<td style="font-size:0.7em;font-weight:300;" class="tableitem"><p>Ngày bán: <?php echo e($date->day.'/'.$date->month.'/'.$date->year); ?></p></td>
						<td style="font-size:0.7em;font-weight:300;" class="tableitem"><p>Quầy: 123</p></td>
					<tr>
				</td>
				<td>
					<tr>
						<td style="font-size:0.7em;font-weight:300;" class="tableitem"><p>Hóa đơn: <?php echo e($ordernumber); ?></p></td>
						<td style="font-size:0.7em;font-weight:300;" class="tableitem"><p>NVBH: <?php echo e($user->name); ?></p></td>
					</tr>
				</td>
			</tr>
		</table>
			...
			<table width='100%'>
				...
				<?php if(isset($rs_orderproduct)): ?>
				  <?php $__currentLoopData = $rs_orderproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<tr class="service" width='100%'>
							<td style="font-size:0.7em;font-weight:300;" width='40%' class="tableitem"><p class="itemtext"><?php echo e($row['namepro']); ?></p></td>
							<td style="font-size:0.7em;font-weight:300;" width='25%' class="tableitem"><p class="itemtext"><span class="currency"><?php echo e($row['price']); ?></span><span class="vnd"></span></p></td>
							<td style="text-align:center;font-size:0.7em;font-weight:300;" width='10%' class="tableitem" style="text-align:center;"><p class="itemtext"><?php echo e($row['amount']); ?></p></td>
							<td style="font-size:0.7em;font-weight:300;" width='25%' class="tableitem"><p class="itemtext"><span class="currency"><?php echo e($unitprice_quality); ?></span><span class="vnd"></span></p></td>
						</tr>
					...
					<tr id="service" class="service" width='100%'>
						...
						<td style="border-top:1px dotted #000;font-size:0.7em;font-weight:300;" class="tableitem"><p class="itemtext"><span class="currency"><?php echo e($subtotal); ?></span><span class="vnd"></span></p></td>
					</tr>
				<?php endif; ?>
			</table>
		</div><!--End Table-->
		<div style="width:100%;text-align:left;font-size:0.7em;font-weight:300;">
			...
			<div style="text-align:left">
				<?php $__currentLoopData = $rs_customerorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<p>Họ tên: <?php echo e($customer['lastname']); ?> <?php echo e($customer['middlename']); ?> <?php echo e($customer['firstname']); ?></p>
						<p>Điện thoại: <?php echo e($customer['mobile']); ?></p>
						<p>Địa chỉ: <?php echo e($customer['address'].','.$customer['nameward'].','.$customer['namedist'].','.$customer['namecitytown'].','.$customer['nameprovince'].','.$customer['namecountry']); ?></p>
						<?php endif; ?>
					  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
			</div>
		</div>
...
<?php $__env->startSection('other_scripts'); ?>
    ...
    <script src="<?php echo e(asset('gentelella/build/js/custom-init.js?v=0.1.9.5')); ?>"></script> 
	 <script src="<?php echo e(asset('gentelella/build/js/print.js?v=0.3.9')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.general',compact('title'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thucpham/domains/thucphamsachban.com/public_html/resources/views/admin/orderlist/print-epos.blade.php ENDPATH**/ ?>