	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-offset-3 text-center">
				...
				<p> <a href="<?php echo e(url('/')); ?>" class="theme_button color3 min_width_button">Back to homepage</a> </p>
...
<?php echo $__env->make('teamilk.master', ['title' => $title,'template'=>$_template ], compact('rs_you_foot','rs_menu2','rs_menu3','rs_menu1','rs_logo_footer','rs_logo_header'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thucpham/domains/thucphamsachban.com/public_html/resources/views/teamilk/product/error-404.blade.php ENDPATH**/ ?>