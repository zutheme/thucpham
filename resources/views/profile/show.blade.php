                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <p></p><label>Nữ:&nbsp;</label><input type="radio" class="flat" name="sel_sex"  value="0" {{ $sel_sex == 0  ? 'checked="" required' : '' }}/>&nbsp;<label>Nam:&nbsp;</label><input type="radio" class="flat" name="sel_sex"  value="1" {{ $sel_sex == 1  ? 'checked="" required' : '' }}/>
                      ...
                      <div class="form-group">
                        ...
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">SIP</label>

                        <div class="col-md-9 col-sm-9 col-xs-12">

                          <input name="sip" value="{{ $sip }}" class="form-control col-md-7 col-xs-12" type="text">
...
@section('other_scripts')
    ...
    <!-- bootstrap-daterangepicker -->
   <script> var birthday = '{{ $birthday }}'; </script>
    ...
    <script src="{{ asset('gentelella/vendors/cropper/dist/cropper.min.js') }}"></script>

    {{-- <script src="{{ asset('dashboard/build/js/custom.min.js') }}"></script> --}}

    <script src="{{ asset('gentelella/vendors/echarts/dist/echarts.min.js') }}"></script>

   {{--  <script src="{{ asset('gentelella/build/js/custom.js?v=0.0.8') }}"></script> --}}
   <script src="{{ asset('gentelella/build/js/custom-build.js?v=0.1.4') }}"></script> 
