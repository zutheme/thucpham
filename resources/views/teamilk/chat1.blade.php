        ...
        <div class="row">
            <div class="col-md-12">
                <div class="c-content-title-1">
                    <h3 class="c-font-34 c-font-center c-font-bold c-font-uppercase c-margin-b-30"> Khám bệnh online </h3>
                    ...
                    <ul class="nav c-tab-icon-stack c-font-sbold c-font-uppercase">
                        ...
                        <li>
                            <a href="#c-tab2-opt1-2" data-toggle="tab">
                                ...
                                <span class="c-title">Tư vấn</span>
                            </a>
                            <div class="c-arrow"></div>
                        </li>
                        <li>
                            <a href="#c-tab2-opt1-3" data-toggle="tab">
                                ...
                                <span class="c-title">Tìm hiểu</span>
                            </a>
                            <div class="c-arrow"></div>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#c-tab2-opt1-5" data-toggle="tab">
                                ...
                                <span class="c-title">Trị liệu</span>
                            </a>
                            <div class="c-arrow"></div>
                        </li>
                    </ul>
                    <div class="c-tab-content">
                        <div class="c-bg-img-center1" style="background-image: url({{ asset('assets-tea/assets/base/img/content/backgrounds/bg-62.jpg') }}">
                            <div class="container">
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="c-tab2-opt1-1">
                                        <div class="c-tab-pane">
                                            <img class="img-responsive" src="{{ asset('assets-tea/assets/base/img/content/stock2/3.jpg') }}" alt="">
                                            ...
                                            <button class="btn btn-sm c-theme-btn c-btn-square c-btn-bold"> Khám phá </button>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="c-tab2-opt1-2">
                                        <div class="c-tab-pane">
                                            <img class="img-responsive" src="{{ asset('assets-tea/assets/base/img/content/stock2/04.jpg') }}" alt="">
                                    ...
                                    <div class="tab-pane fade" id="c-tab2-opt1-3">
                                        <div class="c-tab-pane">
                                            <img class="img-responsive" src="{{ asset('assets-tea/assets/base/img/content/stock2/5.jpg') }}" alt="">
                                    ...
                                    <div class="tab-pane fade" id="c-tab2-opt1-4">
                                        <div class="c-tab-pane">
                                            <img class="img-responsive" src="{{ asset('assets-tea/assets/base/img/content/stock2/06.jpg') }}" alt="">
                                    ...
                                    <div class="tab-pane fade" id="c-tab2-opt1-5">
                                        <div class="c-tab-pane">
                                            <img class="img-responsive" src="{{ asset('assets-tea/assets/base/img/content/stock2/6.jpg') }}" alt="">
