...
@foreach($rs_lstordsess as $row)
	{{-- @if($row['parent']==0) --}}
		<?php $idparent = $row['idorder']; ?>	
			...
			<div class="row c-cart-table-row">
				...
				<input type="hidden" class="parent" name="parent" value="{{ $row['parent'] }}">
	...
	@endforeach
			...
			<div class="c-cart-buttons">
				...
				<a href="{{ url('/cart/checkout') }}" class="btn c-btn btn-lg c-theme-btn c-btn-square c-font-white c-font-bold c-font-uppercase c-cart-float-r">Kế tiếp</a>
			</div>
		</div>
	</div>
