							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="row">
										...
										<input type="hidden" class="form-control c-square c-theme" name="lastname" placeholder="" value="{{ $lastname }}">
										<input type="hidden" class="form-control c-square c-theme" name="middlename" placeholder="" value="{{ $middlename }}">
									</div>
			...
			@foreach($rs_lstordsess as $row)
				 ...
				 <?php $_total_item_parent = $row['price']*$row['inp_session'];?>
					...
					<li class="row c-margin-b-15 c-margin-t-15">
						...
						<div class="col-md-6 c-font-20"><a href="{{ action('teamilk\ProductController@show',$row['idproduct']) }}" class="c-theme-link">{{ $row['namepro'] }} x  {{ $row['inp_session'] }} (*)</a></div>
