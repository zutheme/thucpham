<div class="c-content-box c-size-md c-bg-white">
	...
	<div class="container">
		...
		<div class="c-content-title-1">
			...
			<h3 class="c-center c-font-uppercase c-font-bold">Gia dụng</h3>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="btn-group c-border-top" role="group">
				<a href="{{ url('/') }}/gia-dung" class="btn btn-lg c-btn-white-transparent c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">Xem thêm</a>
			</div>
			</div>
		</div>
	</div>
