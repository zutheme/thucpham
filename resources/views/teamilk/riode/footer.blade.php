				...
				<div class="col-lg-4 col-md-12">
					<div class="widget widget-about">
						<a href="demo-food.html" class="logo-footer">
							<img src="{{ asset('public/riode/images/demos/demo-food/logo-footer.png') }}" alt="logo-footer" width="154" height="43">
						</a>
		...
		<div class="footer-bottom">
			<div class="footer-left">
				<figure class="payment">
					<img src="{{ asset('public/riode/images/payment.png') }}" alt="payment" width="159" height="29">
				</figure>
			</div>
