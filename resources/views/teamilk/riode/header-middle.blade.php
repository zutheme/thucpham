	...
	<div class="container">
		<div class="header-left">
			...
			<a href="{{ url('/') }}" class="logo">
				<img src="{{ asset($_logo[0]->urlfile) }}" alt="{{ $_logo[0]->namepro }}" width="153" height="44">
			</a>
			<!-- End Logo -->
		...
		<div class="header-right">
			<a href="tel:{!! $_call[0]->link !!}" class="icon-box icon-box-side">
					...
					<div class="products scrollable">
						<div class="product product-cart">
							<figure class="product-media">
								<a href="product.html">
									<img src="{{ asset('public/riode/images/cart/product-1.jpg') }}" alt="product" width="80" height="88">
								</a>
						...
						<div class="product product-cart">
							<figure class="product-media">
								<a href="product.html">
									<img src="{{ asset('public/riode/images/cart/product-2.jpg') }}" alt="product" width="80" height="88">
								</a>
								<button class="btn btn-link btn-close">
									<i class="fas fa-times"></i><span class="sr-only">Close</span>
								</button>
