...
<div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space bg-shop23">
	...
	<div class="c-content-title-1">
		<h3 class="c-font-uppercase c-center c-font-bold c-font-black">Sách, văn phòng phẩm</h3>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="btn-group c-border-top" role="group">
				<a href="{{ url('/') }}/sach-tong-hop" class="btn btn-lg c-btn-white-transparent c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">Xem thêm</a>
			</div>
			</div>
		</div>
	</div>
