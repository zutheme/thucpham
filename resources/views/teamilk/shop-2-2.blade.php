...
<div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space custom-kv">

	<div class="container">

		<div class="c-content-title-4">

			<h3 class="c-font-uppercase c-center c-font-bold c-line-strike"><span class="c-bg-white">Làm đẹp</span></h3>

		</div>

		<div class="row">

			<div data-slider="owls">
				...
				<div class="owl-carousel owl-theme c-theme owl-small-space c-owl-nav-center" data-rtl="false" data-items="4" data-slide-speed="8000">
					...
					@if(isset($popular19lkv))

						@foreach($popular19lkv as $row)
							...
							<div class="item">
								...
								<div class="c-content-product-2 c-bg-white c-border">
									...
									<div class="c-content-overlay">
										...
										<div class="c-bg-img-center-contain c-overlay-object custom-item" data-height="width" style="background-image: url({{ asset( $row['urlfile'] ) }});"></div>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="btn-group c-border-top" role="group">
				<a href="{{ url('/') }}/lam-dep" class="btn btn-lg c-btn-white-transparent c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">Xem thêm</a>
			</div>
			</div>
		</div>
	</div>
