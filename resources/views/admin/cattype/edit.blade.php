...
<div class="row">
	<div class="col-sm-6">
		...
		@endif
		<form method="post" action="{{action('Admin\CategoryTypeController@update',$idcattype)}}">
			{{ csrf_field() }}
			<input type="hidden" name="_method" value="PATCH">
			<div class="form-group">
				<input type="text" name="catnametype" class="form-control" value="{{$cattype->catnametype}}">
			</div>
			<div class="form-group">
