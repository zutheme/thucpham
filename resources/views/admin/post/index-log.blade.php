...
<ul>
  @foreach($rs_log as $row)
	<li>{{ $row['created_at'] }},{{ $row['content'] }}</li>  
  @endforeach
</ul>
@stop
...
@section('other_scripts')
    ...
    <script src="{{ asset('dashboard/production/js/filter_select_category.js?v=0.2.4') }}"></script> 
    ...
    @if($posttype == 'survey')
      ...
      <script src="{{ asset('dashboard/production/js/interactive/select_category_tag.js?v=0.0.0.6') }}"></script>
    @endif  
@stop