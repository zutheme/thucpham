	...
	<div class="form-group">
		<div class="col-md-12">
			<input type="hidden" name="title" class="form-control"  value="{{ $product[0]['namepro'] }}" disabled />
		</div>
	</div>
	<div class="form-group">
		<div class="col-md-12">
			<input type="hidden" name="slug" class="form-control" value="{{ $product[0]['slug'] }}" disabled>
		</div>
	</div>
	<div class="form-group">
		<div class="col-md-12">
