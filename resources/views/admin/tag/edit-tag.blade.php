<form class="frm_create_post" method="post" action="{{ action('Admin\TagController@update', $idtag ) }}" enctype="multipart/form-data">
			{{ csrf_field() }}
			<div class="col-md-9 col-xs-12">
				<div class="control-group row">
					<label class="control-label col-md-12 col-sm-12 ">Thẻ tag</label>
					<div class="col-md-12 col-sm-12 ">
						<input id="tags_1" type="text" name="tag" class="tags form-control" value="{{ $rs_tag[0]['nametag'] }}" />
