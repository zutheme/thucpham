   ...
   <div class="row">
	...
	<div class="card">
	    <div class="card-body">
			...
			@endif
			<div align="right">
				<a class="btn btn-default btn-primary" href="{{ route('admin.option.create') }}">Thêm mới</a>
			</div>
	                ...
	                <tbody>
	                	@foreach($options as $row)
							<tr>
								...
								<td class="btn-control"><a class="btn btn-primary btn-edit" href="{{ action('Admin\OptionController@edit',$row['option_id']) }}"><i class="fa fa-edit"></i></a></td>
								<td class="btn-control">
								     <form method="post" class="delete_form" action="{{action('Admin\OptionController@destroy', $row['option_id'])}}">
								      {{csrf_field()}}
