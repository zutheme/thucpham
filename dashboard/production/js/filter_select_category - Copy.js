...
_e_sel_idcat_main.addEventListener("change", function(){
    ...
    if(select_idcat > -1){
       var nametypecat = 'post';
      select_category(select_idcat,nametypecat);
      
    }

});

function select_category(select_idcat,nametypecat){
  ...
  //var url = url_home + "/admin/ListCateByTypeId/"+nametypecat+'/'+select_idcat;
  var url = url_home + "/admin/lstcategorybyid/"+select_idcat+"/"+nametypecat;
